...
<p>Ecrire un programme afin d'afficher le carré de la première valeur</p>
 <%  int valeur1 = Integer.parseInt(tableauDeChiffres[0]) * Integer.parseInt(tableauDeChiffres[0]);  %>  
<%=valeur1%>
          
<h2>Exercice 2 : La somme des 2 premières valeurs</h2>
<p>Ecrire un programme afin d'afficher la somme des deux premières valeurs</p>
 <%  int valeur2 = Integer.parseInt(tableauDeChiffres[0]) + Integer.parseInt(tableauDeChiffres[1]);  %>
 <%=valeur2%>
...
<% 
        int valeur4 = Integer.parseInt(tableauDeChiffres[0]);
        for(int i = 1; i < tableauDeChiffres.length; i++){
            if(valeur4 < Integer.parseInt(tableauDeChiffres[i])){
                valeur4 = Integer.parseInt(tableauDeChiffres[i]);
            }
        }
    %>
<%=valeur4%>
...
<% 
        int valeur5 = Integer.parseInt(tableauDeChiffres[0]);
        for(int i = 1; i < tableauDeChiffres.length; i++){
            if(valeur5 > Integer.parseInt(tableauDeChiffres[i])){
                valeur5 = Integer.parseInt(tableauDeChiffres[i]);
            }
        }
    %>
<%=valeur5%>
...
<% 
        int valeur6 = Integer.parseInt(tableauDeChiffres[0]);
        int abs1 = 0;
        int abs = 0;
...
<% 
        int valeur7 = Integer.parseInt(tableauDeChiffres[0]);
